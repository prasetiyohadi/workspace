...
[Azure Workload Identity](https://azure.github.io/azure-workload-identity) uses
Kubernetes primitives to associate managed identities for Azure resources and
identities in Azure Active Directory (AAD) with pods.

[GitHub](https://github.com/Azure/azure-workload-identity)
