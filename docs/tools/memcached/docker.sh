...
set -euo pipefail
###
### memcached/docker.sh - manage memcached container
###
...
#clean##
#clean## memcached/docker.sh - manage memcached container
#clean##
...
#deploy##
#deploy## memcached/docker.sh - manage memcached container
#deploy##
...
#deploy##   network Create memcached docker network
