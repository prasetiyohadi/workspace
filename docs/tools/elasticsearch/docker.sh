...
set -euo pipefail
###
### elasticsearch/docker.sh - manage elasticsearch container
###
...
#clean##
#clean## elasticsearch/docker.sh - manage elasticsearch container
#clean##
...
#deploy##
#deploy## elasticsearch/docker.sh - manage elasticsearch container
#deploy##
...
#deploy##   network Create elasticsearch docker network
