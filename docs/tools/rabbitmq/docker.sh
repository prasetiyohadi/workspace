...
set -euo pipefail
###
### rabbitmq/docker.sh - manage rabbitmq container
###
...
#clean##
#clean## rabbitmq/docker.sh - manage rabbitmq container
#clean##
...
#deploy##
#deploy## rabbitmq/docker.sh - manage rabbitmq container
#deploy##
...
#deploy##   network Create rabbitmq docker network
