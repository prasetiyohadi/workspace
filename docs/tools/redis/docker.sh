...
set -euo pipefail
###
### redis/docker.sh - manage redis container
###
...
#clean##
#clean## redis/docker.sh - manage redis container
#clean##
...
#deploy##
#deploy## redis/docker.sh - manage redis container
#deploy##
...
#deploy##   network Create redis docker network
