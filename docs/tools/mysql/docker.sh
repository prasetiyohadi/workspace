...
set -euo pipefail
###
### mysql/docker.sh - manage mysql container
###
...
#clean##
#clean## mysql/docker.sh - manage mysql container
#clean##
...
#deploy##
#deploy## mysql/docker.sh - manage mysql container
#deploy##
...
#deploy##   network Create mysql docker network
