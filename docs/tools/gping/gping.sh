...
APP_APIURL=https://api.github.com/repos/orf/gping
APP_APIURL=$APP_APIURL/releases/latest
APP_BASEURL=https://github.com/orf/gping/releases/download
APP_BIN=gping
...
APP_URL=$APP_BASEURL/gping-v$APP_VERSION/$APP_PKG
