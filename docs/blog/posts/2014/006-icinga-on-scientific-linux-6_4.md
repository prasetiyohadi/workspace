...
Search icinga package using **yum search** in _RPMForge_ repository.
...
Don't forget to disable _Selinux_ if you do not use it. Insert database credential into file _ido2db.cfg_.
